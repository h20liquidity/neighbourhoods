import config from "../np-config.json"; 


export const getRainBuyNhtString = (network) => {

    const arbInstance = config.contracts[network].GenericPoolOrderBookFlashBorrowerInstance.address 
    ...
    // String version of factory address.
        ...
        `approved-counterparty: ${arbInstance},`+

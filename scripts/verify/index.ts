...
export async function isContractVerified(toNetwork: string,  address_: string): Promise<boolean> {
    const url = `${getEtherscanBaseURL(toNetwork)}?module=contract&action=getsourcecode&address=${address_}&apikey=${getEtherscanKey(toNetwork)}`;
...
export const verify = async (
       ...
       try { 
            ...
            let isVerified = await isContractVerified(toNetwork,toContract)  

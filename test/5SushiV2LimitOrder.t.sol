...
contract Test4SushiV2LimitOrder is Test5SushiV2LimitOrderUtil {
    ...
    function testLimitOrderReal(uint256 orderHash, uint256 vaultId, uint256 balanceDiff) public {
    ...
    function calculateBatch(uint256 orderHash, uint256 newReceived18) internal view returns(uint256,uint256,uint256){ 
    ...
    function checkCalculateStack(
        ...
        (,uint256 batchIndex,uint256 batchRemaining) = calculateBatch(orderHash,balanceDiff.scale18(limitOrder.context[3][1],1));
